...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val intent = Intent(this@MainActivity, My3DSActivity::class.java)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode == REQUEST_SDK) {
            var res2c2p = data?.extras?.getParcelable<My2c2pResponse>(My2c2pResponse.RESPONSE)
            Toast.makeText(this , res2c2p?.respCode , Toast.LENGTH_LONG).show()
        }
    }
}
